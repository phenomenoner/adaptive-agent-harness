...
projection. The 20-row `v0.6.0a1` acceptance matrix is an in-tree frozen claim budget. Commit, tree,
...
`adaptive-agent-runtime-v0.6.0a1-release-receipt.json`.
...
`aar_capabilities` call and verify package `0.6.0a1`, operation skill `0.11.0`, attached-supervisor
