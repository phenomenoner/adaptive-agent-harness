...
> Den kanoniske README-en er på engelsk. Språkvelgeren setter tradisjonell kinesisk først med vilje.
...
Les [TECHNICAL-STATUS.md](../../TECHNICAL-STATUS.md), [HOST-COMPATIBILITY.md](../../HOST-COMPATIBILITY.md) og [WAL.md](../../WAL.md) før du kommer med påstander om produksjonsbruk.
