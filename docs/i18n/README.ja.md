...
> 英語版 README が正本です。言語スイッチャーでは意図的に繁体字中国語を先頭に置いています。
...
production claims を行う前に、[TECHNICAL-STATUS.md](../../TECHNICAL-STATUS.md)、[HOST-COMPATIBILITY.md](../../HOST-COMPATIBILITY.md)、[WAL.md](../../WAL.md) を読んでください。
