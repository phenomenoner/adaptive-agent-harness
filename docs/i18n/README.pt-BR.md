...
- 38 ferramentas MCP na superfície v8 atual;
...
Leia [TECHNICAL-STATUS.md](../../TECHNICAL-STATUS.md), [HOST-COMPATIBILITY.md](../../HOST-COMPATIBILITY.md) antes de fazer afirmações de produção.
