...
> README chuẩn là tiếng Anh. Bộ chuyển đổi ngôn ngữ cố ý đặt tiếng Hoa phồn thể lên đầu.
...
- 30 công cụ MCP trên bề mặt v7 hiện tại;
...
Hãy đọc [TECHNICAL-STATUS.md](../../TECHNICAL-STATUS.md), [HOST-COMPATIBILITY.md](../../HOST-COMPATIBILITY.md) và [WAL.md](../../WAL.md) trước khi đưa ra các tuyên bố về production.
