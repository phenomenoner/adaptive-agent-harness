...
| A1b | Operator/readback/evaluation contract models | doing | A1a | contract prerequisites for A-MIG-008/A-MIG-009/A-MIG-010 and later B/C/E/G rows | Op1 commit `d03a10f4ac1cc18b43addb0e62245073f7274e3e`: six operator-authority schemas plus ten nested records, 15 focused PASS and Ruff ×2 on exact two files. Op2 readback/grants and eval classification/planning remain pending; no row closure or launcher/attempt authority. |
