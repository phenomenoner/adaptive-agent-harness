...
| S0 | SDD successor for activation/provider-ready authority domains | review_pending | P1, A0 | contract prerequisites; no implementation row closure | Generation-12 S0 passed but its op2 packet remained blocked; Generation-13 adds only the migration-required capability/method restriction, deterministic PASS ×2, independent review pending. |
...
| A1b | Operator/readback/evaluation contract models | doing | A1a | contract prerequisites for A-MIG-008/A-MIG-009/A-MIG-010 and later B/C/E/G rows | Op1 commit `d03a10f4ac1cc18b43addb0e62245073f7274e3e` focused-green. Op2 rev1-rev3 are historical blocked; Generation-13/op2 rev4 dual review pending. Eval remains pending; no row closure or launcher/attempt authority. |
