...
| A1b | Operator/readback/evaluation contract models | doing | A1a | contract prerequisites for A-MIG-008/A-MIG-009/A-MIG-010 and later B/C/E/G rows | Op1 focused-green. Op2 rev4 independently PASS/BATCH_COMPLETE with findings=[]; writer task-start/collision gate pending. Rev1-rev3 remain historical blocked. Eval remains pending; no row closure or launcher/attempt authority. |
